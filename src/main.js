...
const customer  = new Customer({name: 'Erick Ramirez'});
...
console.log(`The Customer ${customer.name} with ID ${customer.id} has a total price of ${customer.lastOrderTotalPrice} on its last`);
